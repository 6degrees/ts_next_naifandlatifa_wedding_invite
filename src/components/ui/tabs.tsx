...
>(({ className, ...props }, ref) => (
  <TabsPrimitive.List
    ref={ref}
    className={cn(
      "inline-flex h-14 items-center justify-center rounded-lg border border-white bg-transparent p-1 text-gray-500 font-arbMuslimah",
      className
    )}
    {...props}
  />
...
>(({ className, ...props }, ref) => (
  <TabsPrimitive.Trigger
    ...
    className={cn(
      ...
      "hover:bg-white/10 hover:border-white hover:text-gray-700",
      className
    )}
    {...props}
  />
